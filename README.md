...
<title>webscraping walkscore</title>
...
<h1 id="Method1:-Use-Selenium(webdriver)--work-for-Javasript">Method1: Use Selenium(webdriver)- work for Javasript<a class="anchor-link" href="#Method1:-Use-Selenium(webdriver)--work-for-Javasript">&#182;</a></h1>
</div>
</div>
</div>
<div class="cell border-box-sizing text_cell rendered"><div class="prompt input_prompt">
...
<div class="text_cell_render border-box-sizing rendered_html">
<h2 id="1.-install-package">1. install package<a class="anchor-link" href="#1.-install-package">&#182;</a></h2>
</div>
</div>
</div>
...
<div class=" highlight hl-ipython3"><pre><span></span><span class="n">pip</span> <span class="n">install</span> <span class="n">selenium</span>
</pre></div>
...
<pre>Requirement already satisfied: selenium in c:\users\yingy\anaconda3\lib\site-packages (3.141.0)
...
<div class="text_cell_render border-box-sizing rendered_html">
<h1 id="2.-Use-Driver-and-BeautifulSoup:">2. Use Driver and BeautifulSoup:<a class="anchor-link" href="#2.-Use-Driver-and-BeautifulSoup:">&#182;</a></h1><p>Script ALL raw code on each page first, store it in a list temporarily, and clean it afterwards.</p>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="c1">#install</span>
...
<div class="text_cell_render border-box-sizing rendered_html">
<h1 id="3.-Test,-Extract,-and-Clean-for-ONE-specific-data">3. Test, Extract, and Clean for ONE specific data<a class="anchor-link" href="#3.-Test,-Extract,-and-Clean-for-ONE-specific-data">&#182;</a></h1><p>Whether we could get the value on the page - ONE TRANSACTION ONE ZIP CODE ONLY</p>
...
<pre>&#39;/Users/yuyu2222/Desktop/Yu/web&#39;</pre>
</div>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="c1">#open driver</span>
<span class="n">driver</span> <span class="o">=</span> <span class="n">webdriver</span><span class="o">.</span><span class="n">Firefox</span><span class="p">()</span>
<span class="n">driver</span><span class="o">.</span><span class="n">get</span><span class="p">(</span><span class="s2">&quot;https://www.walkscore.com/score/1890012&quot;</span><span class="p">)</span>

<span class="c1">#change window size to show whole content</span>
<span class="n">driver</span><span class="o">.</span><span class="n">set_window_size</span><span class="p">(</span><span class="mi">1280</span><span class="p">,</span> <span class="mi">796</span><span class="p">)</span>

<span class="c1">#find element by class name</span>
<span class="n">driver</span><span class="o">.</span><span class="n">find_element_by_css_selector</span><span class="p">(</span><span class="s1">&#39;.score-info-link, .unstyled&#39;</span><span class="p">)</span>

<span class="c1">#the context was in driver, store it in soup</span>
...
<span class="c1">#close drive</span>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="c1"># Get loaction name</span>
<span class="n">location</span> <span class="o">=</span> <span class="n">soup</span><span class="o">.</span><span class="n">find</span><span class="p">(</span><span class="s1">&#39;p&#39;</span><span class="p">,{</span><span class="s1">&#39;class&#39;</span><span class="p">:</span><span class="s2">&quot;tight-top tight-bot clear-smallphone dull-link unstyled&quot;</span><span class="p">})</span><span class="o">.</span><span class="n">get_text</span><span class="p">()</span><span class="o">.</span><span class="n">split</span><span class="p">(</span><span class="s2">&quot;in &quot;</span><span class="p">)[</span><span class="mi">1</span><span class="p">]</span>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="c1"># Get Walk Score in the IMG src/alt</span>
<span class="n">all_image_with_alt</span> <span class="o">=</span> <span class="n">soup</span><span class="o">.</span><span class="n">findAll</span><span class="p">(</span><span class="s1">&#39;img&#39;</span><span class="p">,</span> <span class="n">alt</span><span class="o">=</span><span class="kc">True</span><span class="p">)</span>
<span class="n">all_image_with_alt</span>
</pre></div>
...
<div class="output_text output_subarea output_execute_result">
<pre>[&lt;img alt=&#34;Walk Score Logo&#34; height=&#34;33&#34; src=&#34;https://pp.walk.sc/_/s/_i/images/walk-score-2-sm.png&#34; width=&#34;191&#34;/&gt;,
 ...
 &lt;img alt=&#34;map of restaurants, bars, coffee shops, grocery stores, and more near in Higashimurayama&#34; class=&#34;clippy-inner address-header-static-tile&#34; src=&#34;//pp.walk.sc/tile/e/0/748x600/loc/lat=35.7430487/lng=139.4783835.png&#34; width=&#34;374&#34;/&gt;]</pre>
</div>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="c1"># get the string from string after &quot;src=&quot;</span>
<span class="c1"># then get split by &quot;score/&quot;</span>
<span class="n">walk_score</span> <span class="o">=</span> <span class="n">all_image_with_alt</span><span class="p">[</span><span class="mi">2</span><span class="p">][</span><span class="s1">&#39;src&#39;</span><span class="p">]</span><span class="o">.</span><span class="n">split</span><span class="p">(</span><span class="s2">&quot;score/&quot;</span><span class="p">)[</span><span class="mi">1</span><span class="p">]</span><span class="o">.</span><span class="n">replace</span><span class="p">(</span><span class="s2">&quot;.svg&quot;</span><span class="p">,</span><span class="s2">&quot;&quot;</span><span class="p">)</span>
<span class="n">walk_score</span>
</pre></div>
...
<div class="text_cell_render border-box-sizing rendered_html">
<h1 id="4.-Bulk-WebScraping">4. Bulk WebScraping<a class="anchor-link" href="#4.-Bulk-WebScraping">&#182;</a></h1><p>After assure all the code and clean up the content extracted. Apply the code to multiple iteration</p>
...
<span class="n">df</span> <span class="o">=</span> <span class="n">pd</span><span class="o">.</span><span class="n">read_excel</span><span class="p">(</span><span class="s2">&quot;Walk Score_workplace postcode.xlsx&quot;</span><span class="p">)</span>

<span class="c1"># Paste url string before all postcode element in the series</span>
<span class="n">postcode_url</span> <span class="o">=</span> <span class="s2">&quot;https://www.walkscore.com/score/&quot;</span> <span class="o">+</span> <span class="n">df</span><span class="p">[</span><span class="s2">&quot;Postcode&quot;</span><span class="p">]</span><span class="o">.</span><span class="n">astype</span><span class="p">(</span><span class="s2">&quot;str&quot;</span><span class="p">)</span>

<span class="c1">#Get all url</span>
<span class="n">postcode_url</span>
</pre></div>
...
<div class="output_text output_subarea output_execute_result">
<pre>0       https://www.walkscore.com/score/1010032
...
Name: Postcode, Length: 1917, dtype: object</pre>
</div>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="n">postcode_url</span><span class="p">[</span><span class="mi">252</span><span class="p">]</span>
</pre></div>
...
<div class="output_text output_subarea output_execute_result">
<pre>&#39;https://www.walkscore.com/score/9000004&#39;</pre>
</div>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="n">soup_list</span><span class="o">=</span><span class="p">[]</span>
...
<span class="c1">#open driver</span>

<span class="k">for</span> <span class="n">link</span> <span class="ow">in</span> <span class="n">postcode_url</span><span class="p">[</span><span class="mi">1640</span><span class="p">:]:</span>
    <span class="c1"># Open WebDriver</span>
    <span class="n">driver</span> <span class="o">=</span> <span class="n">webdriver</span><span class="o">.</span><span class="n">Firefox</span><span class="p">()</span>
    ...
    <span class="k">except</span><span class="p">:</span>
        <span class="n">soup</span> <span class="o">=</span> <span class="mi">0</span>
    ...
    <span class="c1">#close drive</span>
    <span class="n">driver</span><span class="o">.</span><span class="n">close</span><span class="p">()</span>
    <span class="n">soup_len</span> <span class="o">=</span> <span class="nb">len</span><span class="p">(</span><span class="n">soup_list</span><span class="p">)</span>
    <span class="nb">print</span><span class="p">(</span><span class="n">soup_len</span><span class="p">)</span>
</pre></div>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="nb">len</span><span class="p">(</span><span class="n">soup_list</span><span class="p">)</span>
</pre></div>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="n">test</span><span class="o">=</span><span class="p">[</span><span class="mi">0</span><span class="p">,</span><span class="mi">1</span><span class="p">,</span><span class="mi">2</span><span class="p">,</span><span class="mi">3</span><span class="p">]</span>
<span class="nb">len</span><span class="p">(</span><span class="n">test</span><span class="p">)</span>
...
<div class="text_cell_render border-box-sizing rendered_html">
<h1 id="5.-Clean-the-HTML-code-&amp;-Extract-Value">5. Clean the HTML code &amp; Extract Value<a class="anchor-link" href="#5.-Clean-the-HTML-code-&amp;-Extract-Value">&#182;</a></h1>
</div>
</div>
</div>
<div class="cell border-box-sizing code_cell rendered">
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="n">location_list</span> <span class="o">=</span> <span class="p">[]</span>
<span class="n">walk_score_list</span> <span class="o">=</span> <span class="p">[]</span>
</pre></div>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="k">for</span> <span class="n">soup</span> <span class="ow">in</span> <span class="n">soup_list</span><span class="p">:</span>
    <span class="c1"># 1. Page Found</span>
    <span class="k">if</span> <span class="n">soup</span> <span class="o">!=</span><span class="mi">0</span><span class="p">:</span>
        <span class="c1"># Get loaction name</span>
        <span class="k">try</span><span class="p">:</span>
            <span class="n">location</span> <span class="o">=</span> <span class="n">soup</span><span class="o">.</span><span class="n">find</span><span class="p">(</span><span class="s1">&#39;p&#39;</span><span class="p">,{</span><span class="s1">&#39;class&#39;</span><span class="p">:</span><span class="s2">&quot;tight-top tight-bot clear-smallphone dull-link unstyled&quot;</span><span class="p">})</span><span class="o">.</span><span class="n">get_text</span><span class="p">()</span><span class="o">.</span><span class="n">split</span><span class="p">(</span><span class="s2">&quot;in &quot;</span><span class="p">)[</span><span class="mi">1</span><span class="p">]</span>
        <span class="k">except</span><span class="p">:</span>
            <span class="n">location</span> <span class="o">=</span> <span class="s2">&quot;index error&quot;</span>
        <span class="k">try</span><span class="p">:</span>
            <span class="c1"># Get Walk Score in the IMG src/alt</span>
            <span class="n">all_image_with_alt</span> <span class="o">=</span> <span class="n">soup</span><span class="o">.</span><span class="n">findAll</span><span class="p">(</span><span class="s1">&#39;img&#39;</span><span class="p">,</span> <span class="n">alt</span><span class="o">=</span><span class="kc">True</span><span class="p">)</span>

            <span class="c1"># get the string from string after &quot;src=&quot;</span>
            <span class="c1"># then get split by &quot;score/&quot;</span>
            <span class="n">walk_score</span> <span class="o">=</span> <span class="n">all_image_with_alt</span><span class="p">[</span><span class="mi">2</span><span class="p">][</span><span class="s1">&#39;src&#39;</span><span class="p">]</span><span class="o">.</span><span class="n">split</span><span class="p">(</span><span class="s2">&quot;score/&quot;</span><span class="p">)[</span><span class="mi">1</span><span class="p">]</span><span class="o">.</span><span class="n">replace</span><span class="p">(</span><span class="s2">&quot;.svg&quot;</span><span class="p">,</span><span class="s2">&quot;&quot;</span><span class="p">)</span>
        <span class="k">except</span><span class="p">:</span>
            <span class="n">walk_score</span> <span class="o">=</span> <span class="s2">&quot;index error&quot;</span>
        
    
    <span class="c1"># 2. Page not Found</span>
    <span class="k">else</span><span class="p">:</span>
        <span class="n">location</span> <span class="o">=</span> <span class="s2">&quot;page not found&quot;</span>
        <span class="n">walk_score</span> <span class="o">=</span> <span class="n">np</span><span class="o">.</span><span class="n">nan</span>
        
    <span class="n">location_list</span><span class="o">.</span><span class="n">append</span><span class="p">(</span><span class="n">location</span><span class="p">)</span>
    <span class="n">walk_score_list</span><span class="o">.</span><span class="n">append</span><span class="p">(</span><span class="n">walk_score</span><span class="p">)</span>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="nb">len</span><span class="p">(</span><span class="n">location_list</span><span class="p">)</span>
</pre></div>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="nb">len</span><span class="p">(</span><span class="n">walk_score_list</span><span class="p">)</span>
</pre></div>
...
<div class="text_cell_render border-box-sizing rendered_html">
<h1 id="6.-Convert-Data-type-to-final-DF-format">6. Convert Data type to final DF format<a class="anchor-link" href="#6.-Convert-Data-type-to-final-DF-format">&#182;</a></h1>
</div>
</div>
</div>
<div class="cell border-box-sizing code_cell rendered">
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="n">location_Series</span> <span class="o">=</span> <span class="n">pd</span><span class="o">.</span><span class="n">Series</span><span class="p">(</span><span class="n">location_list</span><span class="p">)</span>
<span class="n">walk_score_Series</span> <span class="o">=</span> <span class="n">pd</span><span class="o">.</span><span class="n">Series</span><span class="p">(</span><span class="n">walk_score_list</span><span class="p">)</span>
</pre></div>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="n">series_list</span> <span class="o">=</span> <span class="p">[</span><span class="n">df</span><span class="p">[</span><span class="s2">&quot;Postcode&quot;</span><span class="p">],</span><span class="n">location_Series</span><span class="p">,</span><span class="n">walk_score_Series</span><span class="p">]</span>
<span class="n">result_df</span> <span class="o">=</span> <span class="n">pd</span><span class="o">.</span><span class="n">concat</span><span class="p">(</span><span class="n">series_list</span><span class="p">,</span><span class="n">axis</span><span class="o">=</span><span class="mi">1</span><span class="p">)</span>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="n">result_df</span><span class="o">.</span><span class="n">to_excel</span><span class="p">(</span><span class="s2">&quot;walkscore_final.xlsx&quot;</span><span class="p">,</span><span class="n">index</span><span class="o">=</span><span class="kc">False</span><span class="p">)</span>
</pre></div>
